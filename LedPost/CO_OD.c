...
/*0x2101*/  // ODE_CANnodeID is on the flash eeprom data
//ROM UNSIGNED8      ODE_CANnodeID = ODD_CANnodeID;
...
/*******  I/O specific info  ***********************************/
  ...
  OD_ENTRY(0x6000,0x00,ATTR_RO|ATTR_ROM,N_ENTRY_4),  
  OD_ENTRY(0x6000,0x01,ATTR_RW,RGB555Led[0]),    // RGB LED INFO  ( bit 0..4 = R, bit 5..9 = G, bit 10.14=B, bit15 not use)
  OD_ENTRY(0x6000,0x02,ATTR_RW,RGB555Led[1]),   // RGB LED INFO  ( bit 0..4 = R, bit 5..9 = G, bit 10.14=B, bit15 not use)
  OD_ENTRY(0x6000,0x03,ATTR_RW,RGB555Led[2]),    // RGB LED INFO  ( bit 0..4 = R, bit 5..9 = G, bit 10.14=B, bit15 not use)
  OD_ENTRY(0x6000,0x04,ATTR_RW,RGB555Led[3]),    // RGB LED INFO  ( bit 0..4 = R, bit 5..9 = G, bit 10.14=B, bit15 not use)

  OD_ENTRY(0x6001,0x00,ATTR_RO|ATTR_ROM,N_ENTRY_12),
  OD_ENTRY(0x6001,0x01,ATTR_RW,LedsChannel.Led1R),
  OD_ENTRY(0x6001,0x02,ATTR_RW,LedsChannel.Led1G),
  OD_ENTRY(0x6001,0x03,ATTR_RW,LedsChannel.Led1B),
  OD_ENTRY(0x6001,0x04,ATTR_RW,LedsChannel.Led2R),
  OD_ENTRY(0x6001,0x05,ATTR_RW,LedsChannel.Led2G),
  OD_ENTRY(0x6001,0x06,ATTR_RW,LedsChannel.Led2B),
  OD_ENTRY(0x6001,0x07,ATTR_RW,LedsChannel.Led3R),
  OD_ENTRY(0x6001,0x08,ATTR_RW,LedsChannel.Led3G),
  OD_ENTRY(0x6001,0x09,ATTR_RW,LedsChannel.Led3B),
  OD_ENTRY(0x6001,0x0A,ATTR_RW,LedsChannel.Led4R),
  OD_ENTRY(0x6001,0x0B,ATTR_RW,LedsChannel.Led4G),
  OD_ENTRY(0x6001,0x0C,ATTR_RW,LedsChannel.Led4B),
